...
public class Part2 {
	...
	public String getFlat_ownerhip() {
		return flat_ownerhip;
	}

	public void setFlat_ownerhip(String flat_ownerhip) {
		this.flat_ownerhip = flat_ownerhip;
	}
